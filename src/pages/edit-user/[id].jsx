...
const EditUser = () => {
  ...
  const updateUser = async (values) => {
    try {
      await axios.put(`${process.env.NEXT_PUBLIC_API_URL}/users/${id}`, values);
  ...
  return (
    <>
      <ToastContainer
        ...
        theme="colored"
      />
      <Title titlePage="Edit User" textButton="Cancel" href="/" />
      <div className="my-4">
        ...
        >
          {({ handleSubmit, errors, touched }) => (
            <Form onSubmit={handleSubmit}>
              <div className="md:grid md:grid-cols-2 gap-5 my-5 flex flex-col">
                <FormField
                  label="Name"
                  name="name"
                  form={{ errors, touched }}
